...
DROP POLICY IF EXISTS "Users can insert own hosting" ON public.hosting_services;
DROP POLICY IF EXISTS "Users can update own hosting" ON public.hosting_services;
...
DROP POLICY IF EXISTS "Admins can view all hosting" ON public.hosting_services;
DROP POLICY IF EXISTS "Admins can view all invoices" ON public.invoices;
DROP POLICY IF EXISTS "Admins can view all tickets" ON public.support_tickets;
DROP POLICY IF EXISTS "Anyone can view hosting plans" ON public.hosting_plans;
...
-- Hosting services policies
CREATE POLICY "Users can view own hosting" ON public.hosting_services
  FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can insert own hosting" ON public.hosting_services
  FOR INSERT WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can update own hosting" ON public.hosting_services
  FOR UPDATE USING (auth.uid() = user_id);
...
-- Hosting plans can be viewed by everyone (for pricing pages)
